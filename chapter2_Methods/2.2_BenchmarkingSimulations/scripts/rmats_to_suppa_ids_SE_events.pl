...
while(<>){
    ...
    my $s = join "\t", ($suppa_id, $ID, $GeneID, $geneSymbol, $chr, $strand, 
    $exonStart_0base, $exonEnd, $upstreamES, $upstreamEE, $downstreamES, $downstreamEE, 
    $ID2, $IC_SAMPLE_1, $SC_SAMPLE_1, $IC_SAMPLE_2, $SC_SAMPLE_2, $IncFormLen, $SkipFormLen, $PValue, $FDR, $IncLevel1, $IncLevel2, $IncLevelDifference); 
    print $s."\n";
}
